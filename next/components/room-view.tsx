...
export function RoomView() {
  ...
  return (
    <div className="h-full rounded-3xl overflow-hidden relative tech-card hover-3d card-border">
      {/* 房间图片或摄像头 */}
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-2xl font-bold mb-1">客厅</h3>
            <p className="text-sm text-white/80">5 个设备</p>
          </div>

          {/* 移动设备上显示的快捷操作按钮 */}
          <div className="flex md:hidden items-center gap-2">
            <button className="w-10 h-10 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white hover:bg-white/30 transition-all duration-300 card-border">
